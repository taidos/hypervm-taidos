...
#    unlink("hypervm-current.zip");
    ...
    @ unlink("/usr/local/lxlabs/hypervm/etc/install_lxc");
    ...
    system("php54 ../bin/install/create.php --install-type=$installtype --db-rootuser=$dbroot --db-rootpassword=$dbpass");
...
//
    passthru("php54 ../bin/install/virt-install.php --install-type=$installtype --virtualization-type=$virtualization $skiparg");
